#!/usr/bin/env python3
"""Coverage-aware LeetCode pattern sweep helper (dependency-free)."""
...
if __name__ == "__main__":
    ...
    try: raise SystemExit(args.func(args))
    except (ValueError, json.JSONDecodeError) as exc: raise SystemExit(f"Error: {exc}")
